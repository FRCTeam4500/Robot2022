...
public class ConsoleAuto extends SequentialCommandGroup{
    public ConsoleAuto(PathFollowingSwerve swerve, Arm arm, Shooter shooter, Intake intake, Vision vision, Loader loader, Turret turret, Lights lights, PolarVelocityCalculator calculator){

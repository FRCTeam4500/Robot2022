...
public class FirstBall extends SequentialCommandGroup {
    ...
    public FirstBall(PathFollowingSwerve swerve, Arm arm, Intake intake, Shooter shooter, Vision vision, Loader loader, Lights lights, PolarVelocityCalculator calculator){
